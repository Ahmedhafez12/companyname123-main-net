...
const en: Translations = {
  ...
  contactPage: {
    ...
    infoCards: [
      ...
      { title: "Location", text: "Prince Abdulaziz bin Musaid bin Jalawi St., Riyadh, Saudi Arabia" },
    ],
    ...
    reachUsBody: "Prefer phone or email? Pick the channel that suits you and we'll respond the same business day.",
    ...
    privacyNote: "Your information is encrypted and will never be shared with third parties.",
  ...
  heroBanner: {
    ...
    trustedSubtitle: "Partnering with global enterprises to deliver innovative telecommunications solutions.",
  ...
  solutionsCarousel: {
    ...
    solutions: [
      { title: "Managed WiFi", description: "Next-generation mobile network infrastructure for unprecedented speed and reliability." },
      { title: "Managed Fixed Wireless Access", description: "Scalable cloud solutions for modern business needs." },
      { title: "Managed UC", description: "Comprehensive IoT network solutions for smart cities and industries." },
      { title: "Infrastructure", description: "Enterprise-grade mobile connectivity and management platforms." },
      { title: "Special MODA Solutions", description: "High-performance data center infrastructure and management." },
      { title: "Remote Patient Management (RPM)", description: "Seamless international connectivity solutions for global enterprises." },
    ],
  },
  ...
  homePage: {
    ...
    seoDescription: "Hajz Telecommunication Co Ltd. delivers innovative telecom solutions, enterprise connectivity, and transformative network infrastructure across the globe.",
    ...
    services: {
      systemIntegration: {
        ...
        description: "Solutions that fit your network and support digital transformation.",
      },
      connectivityTransmission: {
        title: "Connectivity and Transmission",
        description: "Intelligent gateways that transform infrastructure into competitive advantage.",
      },
      ...
      controlRoomSoftware: {
        ...
        description: "Ergonomic operations and custom software with intuitive interfaces.",
      },
      videoWallsInfrastructure: {
        title: "Video Walls & Infrastructure",
        description: "High-resolution video walls and flexible server infrastructure for scale.",
      },
    },
    telecomPageServices: {
      systemIntegration: {
    ...
    commandPageServices: {
      controlRoom: {
        ...
        description: "Integrated command center environments providing 24/7 mission-critical visualization and ergonomic infrastructure.",
      },
      software: {
        title: "Software",
  ...
  whatWeDoPage: {
    ...
    seoDescription: "Explore Hajz Telecom's service areas: telecommunications, command & control systems, network infrastructure, and managed services for enterprise and government clients.",
    heroBadge: "Next-Generation Solutions",
    heroTitle: "What",
    heroTitleHighlight: "We Do",
    heroSubtitle: "Standard projects are our foundation, but breaking through limitations is our specialty.",
    ...
    solutions: [
      {
        title: "Managed WiFi",
        description: "",
        features: ["Seamless Connectivity", "Centralized Management", "Enhanced Security", "Scalability", "Customizable User Access"],
        benefits: ["Improved User Experience", "Reduced IT Burden", "Optimized Network Performance"],
      },
      {
        title: "Managed Fixed Wireless Access",
        description: "",
        features: ["High-Speed Wireless Broadband", "Rapid Deployment", "Scalable Bandwidth Solutions", "Advanced Security & Encryption", "Network Redundancy"],
        benefits: ["Cost-Effective Deployment", "Expanded Coverage", "Reliable Business Operations"],
      },
      {
        title: "Managed UC",
        description: "Comprehensive IoT connectivity solutions for smart cities and industries.",
        features: ["Multi-Channel Communication", "Cloud-Based Collaboration", "AI-Powered Call Routing", "Integrated Contact Center Solutions", "Data Analytics"],
        benefits: ["Enhanced Productivity", "Improved Customer Engagement", "Cost Savings"],
      },
      {
        title: "Infrastructure",
        description: "Advanced security measures protecting your telecommunications infrastructure.",
        features: ["Scalable Network Architecture", "Cloud & Hybrid Deployments", "Automated Management", "High-Speed Fiber Backbone", "Disaster Recovery & Redundancy"],
        benefits: ["Future-Proofing Investments", "Enhanced Reliability & Uptime", "Optimized IT Efficiency"],
      },
      {
        title: "Special MODA Solutions",
        description: "Advanced security measures protecting your telecommunications infrastructure.",
        features: ["Tailored Network Deployment", "Advanced Cybersecurity Measures", "Mission-Critical Connectivity", "Encrypted Data Transmission", "Adaptive Technology Integration"],
        benefits: ["Security & Compliance", "Reliable Performance in Critical Scenarios", "Adaptable to Emerging Threats"],
      },
      {
        title: "RPM (Remote Patient Management)",
        description: "Advanced security measures protecting your telecommunications infrastructure.",
        features: ["Real-Time Patient Monitoring", "Secure Data Transmission", "AI-Based Health Analytics", "Mobile Access & Telehealth Integration", "Automated Alerts & Notifications"],
        benefits: ["Real-time threat response", "Regulatory compliance", "Comprehensive protection"],
      },
    ],
  },
  ...
  telecomPage: {
    ...
    seoDescription: "Comprehensive telecom services: system integration, enterprise connectivity, unified communications, and critical infrastructure for commercial and military applications.",
    badge: "Telecommunications",
    headline: "Telecommunications",
    headlineHighlight: "Telecommunications",
    headlineSuffix: "Solutions",
    subheadline: "Transforming infrastructure chaos into competitive advantage with intelligent connectivity solutions that protect your past while accelerating your future.",
    heroImageAlt: "Telecommunications Network Infrastructure",
    breadcrumbs: { home: "Home", whatWeDo: "What We Do", telecom: "Telecommunications" },
    coreSolutionsTitle: "Our",
    coreSolutionsHighlight: "Core Solutions",
    coreSolutionsSubtitle: "Comprehensive telecommunications solutions designed to meet your enterprise needs",
    serviceStandardsTitle: "Service",
    serviceStandardsHighlight: "Standards",
    swipeHint: "swipe to explore",
    faqSubtitle: "Common questions about our telecommunications services and capabilities.",
    businessUnits: [
      {
        title: "System Integration",
    ...
    faq: [
      ...
      },
      {
        ...
        answer: "We serve a wide range of industries including banking and finance, government and defence, oil and gas, healthcare, hospitality, and education across the region",
      },
      {
      ...
      },
      {
        ...
        answer: "With 32+ years of experience, vendor-agnostic solutions, senior-led project teams, expertise, and deep-dive knowledge in the technology we use regarding our solutions.",
      },
    ],
  },
  ...
  commandControlPage: {
    ...
    seoDescription: "Advanced command and control solutions connecting ELV and IT systems for intelligent building automation, surveillance, and operational performance monitoring.",
    badge: "Command & Control",
    headline: "Command",
    headlineHighlight: "& Control",
    headlineSuffix: "",
    subheadline: "Control Room Solution is a centralized system designed to monitor, manage, and control multiple devices (Surveillance Cameras, IOT Devices, Databases, AI, etc.) across a facility or a network of sites. It plays a critical role in ensuring safety, security, and operational efficiency in environments such as airports, banks, city surveillance systems, industrial plants, and commercial buildings.",
    heroImageAlt: "Command & Control Operations Center",
    breadcrumbs: { home: "Home", whatWeDo: "What We Do", commandControl: "Command & Control" },
    coreSolutionsTitle: "Our",
    coreSolutionsHighlight: "Core Solutions",
    coreSolutionsSubtitle: "We connect the dots between your ELV and other systems—ensuring smooth data flow, improved performance, and intelligent automation.",
    techStackTitle: "The Backbone of Every",
    techStackHighlight: "Command & Control Solution",
    techStackSubtitle: "",
    industriesTitle: "Industries",
    industriesHighlight: "We Serve",
    industriesSubtitle: "From public infrastructure to enterprise operations — we build command centers for every sector.",
    swipeHint: "swipe to explore more",
    faqSubtitle: "Common questions about our command and control integration services.",
    industriesFooter: "Design systems that connect people, data, and decisions for safer, smarter operations.",
    technicalAdvantages: [
      {
        title: "Expertise & Experience",
        description: "At htc we Have a Team world class Engineers who have consult and deployed command center across the Globe",
      },
      {
        title: "Tailored Solutions",
        description: "Our Solutions/design are 100 % tailor made for Each Requirement; we don't sell what we have but its customer requirement only",
      },
      {
        title: "Security First",
        description: "Our prime focus during designing solution is, to secure our customer control room and premises and sites by the use of Technologies",
      },
      {
        title: "Future-Proof Architecture",
        description: "Our scalable solutions grow with your business and support emerging technologies like AI and IoT.and can be Scalable for future",
      },
      {
        title: "End-to-End Support",
        description: "From initial planning to post-deployment support, we're with you every step of the way.",
      },
    ],
    coreSolutions: [
      {
    ...
    processSteps: [
      { title: "Design", description: "Requirements gathering, site surveys, and feasibility studies." },
      { title: "Deploy", description: "Execution with in-house engineering and trusted partners." },
      { title: "Manage", description: "AMC/SLA support for system longevity." },
      { title: "Tailor-Made", description: "Custom AI and software solutions beyond off-the-shelf products." },
      { title: "Cost Cutting", description: "Reducing manpower and operational costs through integration." },
    ],
    faq: [
      {
  ...
  aboutUsPage: {
    ...
    whyUs: {
      ...
      valuePropSubtitle: "What sets us apart in delivering transformative technology solutions.",
      reasonsCount: "5",
