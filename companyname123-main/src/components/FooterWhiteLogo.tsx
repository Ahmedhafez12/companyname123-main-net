...
const FooterWhiteLogo: React.FC<LogoProps> = ({ className = "" }) => {
  return (
    <div className={className}>
      <svg viewBox="0 0 1109.48 491" className="w-full h-full">
        ...
        <text
          ...
          fontSize="40.39"
          transform="translate(514.35 387.72)"
        >
          HAJZ TELECOM CO. LTD.
        </text>
        <text
          className="footer-logo-text"
          fontSize="26.58"
          transform="translate(514.35 422.75)"
        >
...
export default FooterWhiteLogo;
